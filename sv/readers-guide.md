...
Hänvisningar till "beslutsfattare", "chefer" samt "utvecklare och formgivare" gäller alla som utför uppgifter förknippade med dessa roller, oavsett deras tjänstetitel.
Det är vanligt att enskilda personer har uppgifter som spänner över flera roller.

Nedan följer en kort förklaring av vart och ett av dessa avsnitt och hur de används inom standardens kriterier.

## Inledning

Detta avsnitt förklarar vad kriteriet syftar till att uppnå och varför det är viktigt för en kodbas användare och bidragsgivare.

## Krav

Detta avsnitt listar vad som behöver göras för att uppfylla standarden.

Följande nyckelord i detta dokument ska tolkas enligt beskrivningen i [IETF RFC 2119](https://tools.ietf.org/html/rfc2119):
...
Detta avsnitt erbjuder åtgärder du kan vidta för att se om ett bidrag uppfyller standarden.
Detta är avgörande om du vill tillämpa standarden i praktiken.
...
Detta avsnitt riktar sig särskilt till beslutsfattare genom att erbjuda dem konkreta åtgärder de kan vidta i sin roll.
...
Detta avsnitt riktar sig särskilt till chefer genom att erbjuda konkreta åtgärder de kan vidta i sin roll.
...
Detta avsnitt riktar sig särskilt till utvecklare och formgivare genom att erbjuda dem konkreta åtgärder de kan vidta i sin roll.
...
Detta innebär att standarden inte talar om för de som driftsätter hur de ska följa sin organisations lokala tekniska infrastruktur eller rättsliga ramverk.
